    ...
    <header className="bg-white shadow-sm">
      <div className="flex items-center px-6 py-4">
        ...
        <div className="flex items-center space-x-4 ml-auto">
          ...
          <button onClick={handleLogout} className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 font-medium" title="Logout">
            Logout
          </button>
        </div>
      </div>
